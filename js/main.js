 ...
 * Configs
 */
const general_help = `Below there's a list of commands that you can use.
...
var files = (function () {
  ...
  Singleton.defaultOptions = {
    ...
    "attribution.txt": [
      ...
      "Data was pulled in via a custom Strapi installation at api.aster.hn",
      "Feel free to poke around the graphql data at api.aster.hn/graphql",
    ].join("\n"),
  };
  return {
    getInstance: function (options) {
